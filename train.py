...
parser.add_argument('--upscale_factor', default=4, type=int, choices=[0, 2, 4, 8],
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(dataset=train_set, num_workers=1, batch_size=1, shuffle=True)
    val_loader = torch.utils.data.DataLoader(dataset=val_set, num_workers=1, batch_size=1, shuffle=False)
